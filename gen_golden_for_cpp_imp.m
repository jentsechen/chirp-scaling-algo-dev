...
% save('echo_signal_golden.mat', 'point_target_echo_signal');
chirp_scaling_algo = ChirpScalingAlgo("imaging_par", imaging_par);

disp("migr_par");
migr_par = chirp_scaling_algo.migr_par;
save("./golden/migr_par.mat", "migr_par");

disp("modified_range_fm_rate_hz_s");
modified_range_fm_rate_hz_s = chirp_scaling_algo.modified_range_fm_rate_hz_s;
save("./golden/modified_range_fm_rate_hz_s.mat", "modified_range_fm_rate_hz_s");

disp("chirp_scaling");
chirp_scaling = chirp_scaling_algo.chirp_scaling;
save("./golden/chirp_scaling.mat", "chirp_scaling");

disp("range_comp_filt");
range_comp_filt = chirp_scaling_algo.range_comp_filt;
save("./golden/range_comp_filt.mat", "range_comp_filt");

disp("azimuth_comp_filt");
azimuth_comp_filt = chirp_scaling_algo.azimuth_comp_filt;
save("./golden/azimuth_comp_filt.mat", "azimuth_comp_filt");

disp("second_comp_filt");
second_comp_filt = chirp_scaling_algo.second_comp_filt;
save("./golden/second_comp_filt.mat", "second_comp_filt");

disp("third_comp_filt");
third_comp_filt = chirp_scaling_algo.third_comp_filt;
save("./golden/third_comp_filt.mat", "third_comp_filt");
...
save("./golden/azimuth_fft_out.mat", "azimuth_fft_out");
save("./golden/chirp_scaling_out.mat", "chirp_scaling_out");
save("./golden/range_fft_out.mat", "range_fft_out");
save("./golden/second_phase_func_out.mat", "second_phase_func_out");
save("./golden/range_ifft_out.mat", "range_ifft_out");
save("./golden/third_phase_func_out.mat", "third_phase_func_out");
save("./golden/csa_out.mat", "csa_out");
